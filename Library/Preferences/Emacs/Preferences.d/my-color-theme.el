...
(defun my-color-theme ()
  ...
  (color-theme-install
   '(my-color-theme
     ...
     (lazy-highlight ((t (:background "DarkOliveGreen"))))
     (left-margin ((t (nil))))
     (link ((t (:foreground "blue1" :underline t))))
     (link-visited ((t (:foreground "magenta4" :underline t))))
     (match ((t (:background "DarkOliveGreen"))))
     (menu ((t (nil))))
     (minibuffer ((t (:stipple nil :strike-through nil :underline nil :slant normal :weight normal :width normal))))
     ...
     (mode-line ((t (:underline nil :strike-through nil :stipple nil :background "grey75" :foreground "black" :box (:line-width -1 :style released-button) :strike-through nil :underline nil :slant normal :weight normal :width normal :height 120))))
     (mode-line-buffer-id ((t (:bold t :weight bold))))
     (mode-line-emphasis ((t (:bold t :weight bold))))
     (mode-line-flags ((t (:family "Monaco"))))
     (mode-line-highlight ((t (:box (:line-width 2 :color "grey40" :style released-button)))))
     (mode-line-inactive ((t (:underline nil :strike-through nil :stipple nil :stipple nil :background "#2a2a2c" :foreground "#a2a2c2" :box nil :strike-through nil :underline nil :slant normal :weight normal :height 120 :width normal))))
     ...
     (paren-face-match ((t (:background "DarkGreen" :foreground "Black"))))
     ...
     (show-paren-match ((t (:background "DarkGreen" :foreground "Black"))))
     (show-paren-mismatch ((t (:background "DarkRed" :foreground "Black"))))
     ...
     (widget-field ((t (:background "DarkGray" :foreground "Black"))))
     (widget-inactive ((t (:foreground "grey50"))))
     (widget-single-line-field ((t (:background "DarkGray" :foreground "Black"))))
