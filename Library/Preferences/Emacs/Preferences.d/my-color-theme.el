...
(defun my-color-theme ()
  "Color theme by Siddhartha Reddy, created 2011-05-31."
  (interactive)
  (color-theme-install
   '(my-color-theme
     ...
     (default ((t (:stipple nil :background "#1a1a1c" :foreground "AntiqueWhite" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 110 :width normal :foundry "apple" :family "DejaVu_Sans_Mono"))))
     ...
     (autoface-default ((t (:stipple nil :background "#1a1a1c" :foreground "#F8F8F8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 110 :width normal :foundry "apple" :family "DejaVu_Sans_Mono"))))
     ...
     (c-nonbreakable-space-face ((t (:background "red" :foreground "#EE799F"))))
     (change-log-acknowledgement ((t (:foreground "#5F5A60"))))
     (change-log-conditionals ((t (:foreground "SteelBlue"))))
     (change-log-date ((t (:foreground "OliveDrab"))))
     (change-log-email ((t (:foreground "SteelBlue"))))
     (change-log-file ((t (:foreground "SteelBlue"))))
     (change-log-function ((t (:foreground "SteelBlue"))))
     (change-log-list ((t (:foreground "DarkOrange"))))
     (change-log-name ((t (:foreground "LightSteelBlue"))))
     ...
     (comint-highlight-prompt ((t (:foreground "DarkOrange"))))
     (compilation-column-number ((t (:foreground "#9B703F"))))
     (compilation-error ((t (:background "#EE799F" :foreground "red"))))
     ...
     (completions-common-part ((t (:stipple nil :background "#1a1a1c" :foreground "#F8F8F8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 110 :width normal :foundry "apple" :family "DejaVu_Sans_Mono"))))
     ...
     (font-lock-builtin-face ((t (:foreground "SaddleBrown"))))
     ...
     (font-lock-doc-string-face ((t (:foreground "DarkKhaki"))))
     ...
     (font-lock-variable-name-face ((t (:foreground "SteelBlue"))))
     (font-lock-warning-face ((t (:background "#EE799F" :foreground "red"))))
     (fringe ((t (:foreground "grey55"))))
     (fundamental-mode-default ((t (:underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :stipple nil :background "#1a1a1c" :foreground "#F8F8F8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 110 :width normal :foundry "apple" :family "DejaVu_Sans_Mono"))))
     (gui-element ((t (:background "#D4D0C8" :foreground "black"))))
     (header-line ((t (:stipple nil :background "grey90" :foreground "grey20" :box nil :strike-through nil :underline nil :slant normal :weight normal :height 120 :width normal :family "Lucida Grande"))))
     ...
     (highline-face ((t (:background "#0a0a0c"))))
     ...
     (ido-subdir ((t (:foreground "LightSteelBlue"))))
     (isearch ((t (:background "SeaGreen" :foreground "lightskyblue1"))))
     (isearch-fail ((t (:background "DarkRed"))))
     (italic ((t (:italic t :slant italic))))
     (latex-mode-default ((t (:stipple nil :background "#1a1a1c" :foreground "#F8F8F8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 130 :width normal :foundry "apple" :family "Lucida Grande"))))
     (lazy-highlight ((t (:background "DarkOliveGreen" :foreground "nil"))))
     (left-margin ((t (nil))))
     ...
     (minibuffer-prompt ((t (:underline nil :strike-through nil :stipple nil :stipple nil :foreground "DarkOrange" :strike-through nil :underline nil :slant normal :weight normal :width normal :family "Lucida Grande"))))
     (mlinks-font-lock-face ((t (:foreground "blue1" :underline t))))
     (mlinks-hyperactive-link-face ((t (:background "magenta3" :foreground "lightskyblue1"))))
     ...
     (mode-line-inactive ((t (:underline nil :strike-through nil :stipple nil :stipple nil :background "#2a2a2c" :foreground "#a2a2c2" :box nil :strike-through nil :underline nil :slant normal :weight normal :height 120 :width normal :family "Lucida Grande"))))
     ...
     (nxml-outline-active-indicator ((t (:stipple nil :background "#1a1a1c" :foreground "#F8F8F8" :inverse-video nil :box 1 :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 110 :width normal :foundry "apple" :family "DejaVu_Sans_Mono"))))
     (nxml-outline-ellipsis ((t (:bold t :stipple nil :background "#1a1a1c" :foreground "#F8F8F8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight bold :height 110 :width normal :foundry "apple" :family "DejaVu_Sans_Mono"))))
     (nxml-outline-indicator ((t (:stipple nil :background "#1a1a1c" :foreground "#F8F8F8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 110 :width normal :foundry "apple" :family "DejaVu_Sans_Mono"))))
     ...
     (org-agenda-column-dateline ((t (:background "grey90" :strike-through nil :underline nil :slant normal :weight normal :height 110 :family "DejaVu_Sans_Mono"))))
     ...
     (org-mode-default ((t (:stipple nil :background "#1a1a1c" :foreground "#F8F8F8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "apple" :family "Monaco"))))
     (org-mode-line-clock ((t (:underline nil :strike-through nil :stipple nil :strike-through nil :underline nil :stipple nil :background "#0a0a0c" :foreground "#a0a0c0" :box (:line-width 3 :color "#0a0a0c") :strike-through nil :underline nil :slant normal :weight normal :height 120 :width normal :family "Lucida Grande"))))
     ...
     (org-warning ((t (:background "#EE799F" :foreground "red"))))
     ...
     (paren-face ((t (:foreground "DimGray"))))
     (paren-face-match ((t (:background "DarkOliveGreen" :foreground "nil"))))
     ...
     (show-paren-match ((t (:bold t :background "DarkOliveGreen" :foreground "nil" :slant normal :weight bold))))
     (show-paren-mismatch ((t (:background "DarkRed" :foreground "white"))))
     ...
     (slime-inspector-action-face ((t (:background "#EE799F" :foreground "red"))))
     ...
     (slime-repl-prompt-face ((t (:foreground "DarkOrange"))))
     ...
     (text-mode-default ((t (:stipple nil :background "#1a1a1c" :foreground "#F8F8F8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 130 :width normal :foundry "apple" :family "Lucida Grande"))))
     (tool-bar ((t (nil))))
